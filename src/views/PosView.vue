<template>
  <div class="w-full h-full px-4 md:px-10 flex flex-col">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-10 w-full flex-1 min-h-0 pb-6 md:pb-14">
      ...
      <div class="relative bg-gray-50 rounded-2xl md:rounded-[2rem] w-full h-auto md:h-full min-h-[280px] flex flex-col items-center pb-6 md:pb-10 border-2 border-dashed border-gray-300 overflow-hidden cursor-not-allowed select-none">
        ...
        <div class="flex-grow flex flex-col justify-center items-center z-10 px-4 md:px-6 text-center opacity-60">
            
            <div class="mb-4 md:mb-6">
               <div class="w-24 h-24 md:w-32 md:h-32 bg-gray-200 text-gray-400 text-4xl md:text-6xl flex items-center justify-center rounded-full shadow-inner mx-auto grayscale">
                 👨‍🍳
               </div>
            </div>
      ...
      <div class="group relative bg-white rounded-2xl md:rounded-[2rem] w-full h-auto md:h-full min-h-[280px] flex flex-col items-center pb-6 md:pb-10 shadow-lg hover:shadow-2xl transition-all duration-300 border-2 border-transparent hover:border-blue-200 overflow-hidden">
        
        <div class="absolute top-0 w-full h-1/2 bg-gradient-to-b from-blue-50 to-transparent opacity-60 z-0"></div>
        
        <div class="flex-grow flex flex-col justify-center items-center z-10 px-4 md:px-6 text-center">
            
            <div class="mb-4 md:mb-6 transform group-hover:scale-110 transition-transform duration-300">
               <div class="w-24 h-24 md:w-32 md:h-32 bg-blue-100 text-4xl md:text-6xl flex items-center justify-center rounded-full shadow-inner mx-auto">
                 🔌
               </div>
            </div>
