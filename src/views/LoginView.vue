    ...
    <div class="right-panel">
      <div class="login-wrapper">
        ...
        <form @submit.prevent="handleLogin" novalidate>
          ...
          <button type="button" class="btn-google">Log In with Google</button>
...
const handleLogin = async () => {
  ...
  try {
    ...
    if (msgLower.includes("user not found") || msgLower.includes("email not found")) {
       errors.email = "Email not found";
       errors.password = ""; 
    } 
    else if (msgLower.includes("incorrect password") || msgLower.includes("wrong password")) {
