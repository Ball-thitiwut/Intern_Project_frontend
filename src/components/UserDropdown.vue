...
<template>
  <div class="relative z-40">
    ...
    >
      <div
        class="w-10 h-10 rounded-full bg-white flex items-center justify-center border-2 border-white shadow-sm overflow-hidden"
      >
        <img
      ...
      <div class="flex flex-col items-start">
        <span class="text-sm font-semibold text-[#051960] leading-tight">{{
          userStore.fullName
        }}</span>
      </div>
    ...
    >
      ...
      <div class="px-2">
        <a
          ...
          "
          class="group flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-gray-700 hover:bg-[#EFF6FF] hover:text-[#051960] transition-colors cursor-pointer w-full"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="h-4 w-4 text-gray-400 group-hover:text-[#051960] transition-colors"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
      ...
      <div class="px-2">
        <button
          @click="handleLogout"
          class="w-full flex items-center gap-3 text-left px-3 py-2.5 rounded-lg text-sm font-medium text-red-600 hover:bg-red-50 transition-colors cursor-pointer"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="h-4 w-4"
